...
# custom_nouns 및 stopwords는 그대로 복사
custom_nouns = [
    # 정부기관
...
stopwords = {
    ...
    # 추가 불용어(소리)
    '마련', '둘째', '행정안전부', '수립', '기본', '장관', '제도', '법률안', '번호',
    '참고', '참고 법률안', '법률안 번호', '부칙', '법률 부칙', '절차', '보건복지부',
    '회의', '구성', '사정', '중소벤처기업부', '중소벤처기업부 장관', '해양수산수',
    '해양수산부 장관', '심사', '국회', '법안 심사', '의원', '통지', '여부', '고용노동부',
    '고용노동부 장관', '소관 상임위원회', '소관', '상임위원회', '환경부', '환경부 장관',
    '서비스', '제공', '서비스 제공', '대상자', '국토교통부', '국토교통부 장관', '명령',
    '해양수산부', '행정안전부 장관', '시정', '장관', '이행', '요구', '발생', '조사','실태',
    '실태 조사', '실시', '결과', '조사 결과', '협정', '사무처', '예규', '개정', '검색',
    '게시', '거절', '국토교통부', '당사자', '관할', '주변', '주변 지역', '대책', '미만',
    '명시', '소속', '법률 명시', '시설', '설치', '시설 설치', '운영', '이용', '설치 운영',
    '복합', '조직', '성과', '반영', '자체', '시행', '규모', '보완', '미비', '현행', '일부',
    '취소', '본인', '처벌 규정', '결정', '문화체육관광부', '회원', '설립', '한국', '수행',
    '목적', '역할', '의제', '법정', '사람', '요원', '장치', '부착', '삭제', '절차', '규정 삭제',
    '정비', '조항', '과태료', '가중 처벌', '가중', '주체', '증명', '재단', '농림축산식품부 장관',
    '업자', '승인', '장관 승인', '목적', '상향', '식품의약품안전처', '소방청', '명칭', '명칭 사용',
    '적용', '민간', '소속', '정치', '시효', '처벌', '산림청', '주민', '기본법', '다양', '수거'
}
